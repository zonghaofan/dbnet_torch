...
def main_debug():
    ...
    new_data = makeborderMap(data)
    threshold_map = new_data['threshold_map']
    threshold_mask = new_data['threshold_mask']
    cv2.imwrite('./threshold_map.jpg', threshold_map*255)
    cv2.imwrite('./threshold_mask.jpg' , threshold_mask*255)
