...
class EastRandomCropData():
    def __init__(self, size=(640, 640), max_tries=50, min_crop_side_ratio=0.5, require_original_image=False, keep_ratio=True):
        self.size = size
    ...
    def __call__(self, data: dict) -> dict:
        ...
        for poly, text, tag in zip(text_polys, texts, ignore_tags):
            ...
            # poly = ((np.array(poly) - np.array([crop_x, crop_y])) * scale).tolist()
